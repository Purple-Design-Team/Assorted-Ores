...
public class BlockCopperOre extends ElementsAssortedItemsMod.ModElement {
	@GameRegistry.ObjectHolder("assorted_items:copper_ore")
	public static final Block block = null;
	public BlockCopperOre(ElementsAssortedItemsMod instance) {
		super(instance, 44);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("assorted_items:copper_ore", "inventory"));
	}
